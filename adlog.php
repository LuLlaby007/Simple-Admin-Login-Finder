...
<br>
<?php
//This code was created by ./LuLlaby007
...
function urlExist($url)
{
  ...
  if(filter_var($url, FILTER_VALIDATE_URL))
  {
    ...
    'bb-admin/index.html','bb-admin/login.html','cp/','backend/','backoffice/','acceso.php','bb-admin/admin.html','admin/home.html',
...
<p align="center"><font color="red" size="6">Coded By ./LuLlaby007 | CytoXteam</font>
    ...
    {
    echo '<p align="left"><font color="red">'.$urll.'=>Gaada</font></p>';
    }   
    }
    echo '<p align="left"><font color="white" size="5">Gaada Adlog Nya Bangsat!!</font></p>';
  }
  else
  {
    echo '<p align="left"><font color="red" size="5">Masukin Url Dulu Gblok!!!</font></p>';    
  }
    }
?>
<footer>
